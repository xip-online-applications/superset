...
import {CubeControlPanelDndItem} from '../types';
...
interface CubeControlPanelDragOptionProps extends CubeControlPanelDndItem {
...
export default function CubeControlPanelDragOption(
  props: CubeControlPanelDragOptionProps,
) {
